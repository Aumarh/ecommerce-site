...
import { getFabricById } from '../../util/database';
...
export default function Product(props) {
  ...
  const [fabricCounter, setFabricCounter] = useState(1);
        ...
        <div>
          <Grid container spacing={1}>
            <Grid item md={6} xs={12}>
              <Image
                src={`/images/${props.product.id}.jpeg`}
...
export async function getServerSideProps(context) {
  ...
  const product = await getFabricById(context.query.productId);
